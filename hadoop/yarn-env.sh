...
export HADOOP_CONF_DIR=/software/hadoop-3.3.6/etc/hadoop
export HADOOP_LOG_DIR=/software/hadoop-3.3.6/logs
export HADOOP_CLASSPATH=$HADOOP_HOME/share/hadoop/yarn/*:$HADOOP_HOME/share/hadoop/yarn/lib/*
#
